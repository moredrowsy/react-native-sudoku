...
type SudokuListNavigationProp = BottomTabNavigationProp<
  TabsParamList,
  'SudokuList'
>;
type SudokuListRouteProp = RouteProp<TabsParamList, 'SudokuList'>;

type OwnProps = {
  navigation: SudokuListNavigationProp;
  route: SudokuListRouteProp;
};
