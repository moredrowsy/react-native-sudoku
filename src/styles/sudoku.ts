...
const cellColorTheme: Record<string, CellColors> = {
  ...
  deepPurple: {
    ...
    cellMargin: black,
    cellBackground: white,
    cellOpacityBackground: deepPurple,
    cellSelectedBackground: deepPurple,
    cellSelectedOpacity: white,
    cellSelectedText: white,
    cellRevealBackground: red,
  ...
  purple: {
    ...
    cellMargin: black,
    cellBackground: white,
    cellOpacityBackground: purple,
    cellSelectedBackground: purple,
    cellSelectedOpacity: white,
    cellSelectedText: white,
    cellRevealBackground: red,
    cellRevealOpacityBackground: indigo,
  ...
  red: {
    ...
    cellMargin: black,
    cellBackground: white,
    cellOpacityBackground: red,
    cellSelectedBackground: red,
    cellSelectedOpacity: white,
    cellSelectedText: white,
    cellRevealBackground: indigo,
    cellRevealOpacityBackground: indigo,
  ...
  teal: {
    ...
    cellMargin: black,
    cellBackground: white,
    cellOpacityBackground: teal,
    cellSelectedBackground: teal,
    cellSelectedOpacity: white,
    cellSelectedText: white,
    cellRevealBackground: red,
    cellRevealOpacityBackground: red,
